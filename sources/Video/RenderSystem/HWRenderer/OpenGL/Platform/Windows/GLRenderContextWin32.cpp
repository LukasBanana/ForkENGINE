/*
 * WIN32: OpenGL render context header
 * 
...
#define ERR_GL_CONTEXT_FAILED(s) s " OpenGL render context failed"

static const char* errAntiAliasingNotSupported = "Multi-sample anti-aliasing is not supported";
