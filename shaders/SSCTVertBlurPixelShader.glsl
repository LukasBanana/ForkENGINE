/*
 * SSCT Vertical Blur GLSL pixel shader
 * 
...
void main()
{
	...
	color += texelFetch(tex, coord + ivec2(0,  3), 0) * WEIGHT_0;
	color += texelFetch(tex, coord + ivec2(0,  2), 0) * WEIGHT_1;
	color += texelFetch(tex, coord + ivec2(0,  1), 0) * WEIGHT_2;
